...
pub type DecodeJpeg = unsafe extern "C" fn(*const u8, usize, u32, u32, *mut u8, usize) -> i32;
...
mod tests {
    ...
    fn host_decoder_output_is_owned_and_rejection_falls_back() {
        assert_eq!(
            decode_with(accepted, &[0xff, 0xd8], 2, 1).unwrap(),
            [1, 2, 3, 255, 4, 5, 6, 255]
        );
